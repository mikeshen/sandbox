...
// Given two list of disjoint intervals sorted on their start time, return a list of their
// intersections.
...
void testFunction()
{
    ...
    customAssert(intervalIntersetions(list1, list2) == result) auto vec =
        intervalIntersetions(list1, list2);
}
